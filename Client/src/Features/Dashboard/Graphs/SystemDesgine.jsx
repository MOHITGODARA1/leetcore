...
const nodes = [
    { label: "Requirements", x: 240, y: 30, w: 130 },
    { label: "Scalability", x: 120, y: 170, w: 130 },
    { label: "Availability", x: 380, y: 170, w: 130 },
    { label: "Load Balancer", x: 44, y: 310, w: 130 },
    { label: "Database", x: 238, y: 310, w: 130 },
    { label: "Caching", x: 418, y: 310, w: 130 },
    { label: "Architecture", x: 250, y: 460, w: 130 },
    { label: "Microservices", x: 90, y: 630, w: 130 },
    { label: "Message Queue", x: 270, y: 630, w: 130 },
    { label: "Monitoring", x: 460, y: 630, w: 130 },
];
...
export default SystemDesgineGraph;