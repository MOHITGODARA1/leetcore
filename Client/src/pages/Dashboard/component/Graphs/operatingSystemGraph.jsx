...
const nodes = [
    { label: "Processes", x: 240, y: 30, w: 130 },
    { label: "Threads", x: 120, y: 170, w: 130 },
    { label: "Scheduling", x: 380, y: 170, w: 130 },
    { label: "CPU Scheduling", x: 44, y: 310, w: 130 },
    { label: "Deadlocks", x: 238, y: 310, w: 130 },
    { label: "Synchronization", x: 418, y: 310, w: 130 },
    { label: "Memory Mgmt", x: 250, y: 460, w: 130 },
    { label: "Paging", x: 90, y: 630, w: 130 },
    { label: "Segmentation", x: 270, y: 630, w: 130 },
    { label: "Virtual Memory", x: 460, y: 630, w: 130 },
];
